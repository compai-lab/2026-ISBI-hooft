...
if __name__ == "__main__":
    ...
    def build_dataset(current_patch_size, sample_batch_size, crop_batch_size, fold_idx, sampling):
        ...
        # cache_dir = "/tmp/hodo/cache"
        cache_dir = "/vol/nasciam/datasets/amos_bpr/tmp/cache" # <-- CHANGE THIS TO YOUR LOCAL DATA LOCATION
        if False:
    ...
    for LocContext in ["UNETR_PE"]: #"Baseline", "XYZ", #, "XYZ", "HAN2"#adjust "Baseline",  for conidtions here # , "BPRXY",
        for p_size in ["small"]:# ,"large" , "small" ,"large"
            ...
            #for fold_idx in range(5):
                ...
                max_sample_size = 2  
                num_classes = 16 # number of semantic classes, 14 for BTCV, 
