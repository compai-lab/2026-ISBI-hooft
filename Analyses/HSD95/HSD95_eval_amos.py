...
# For the AMOS dataset, this code iterates over 5 cross-validation folds created for each model type.
...
if __name__ == "__main__":
    ...
    num_classes = 16  # For AMOS dataset
    model_base_path = "/u/home/hodo/Documents/locunet/runs/AMOS/UNet_final_Baseline_large_"
#    0/0.pth  # Change as needed
    model_name = "UNet_final_Baseline_large_"  # e.g., Final_UNETR_large_0.pth
    folds = 5  # K-Fold CV
    ...
    def build_dataset(patch_size, batch_size, crop_batch_size, fold_idx, max_samples=10):
    ...
    for fold_idx in range(folds):
        ...
        with torch.no_grad():
            for batch in tqdm(val_loader, desc=f"Fold {fold_idx} Validation"):
                ...
                # val_outputs = sliding_window_inference(val_inputs.float(), patch_size, batch_size, model)
