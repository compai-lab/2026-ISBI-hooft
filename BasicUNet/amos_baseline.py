...
Description:
This script trains 3D medical segmentation models on volumetric datasets (e.g., AMOS, BTCV) using MONAI-based UNet architectures.
...
if __name__ == "__main__":
    ...
    def build_dataset(current_patch_size, sample_batch_size, crop_batch_size, fold_idx, sampling):
        ...
        # debug: datalist = datalist[:10]

        cache_dir = "/tmp/fst/cache_baseline"
        if False:
